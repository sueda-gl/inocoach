  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 z-50 p-2 rounded-full transition-colors 
                 dark:bg-cosmic-slate dark:hover:bg-cosmic-slate/70 
                 light:bg-light-accent light:hover:bg-gray-200
                 border border-opacity-20 dark:border-white light:border-gray-300"
